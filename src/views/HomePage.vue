  ...
  <ion-page class="master">
    <ion-header class="header ion-no-border">
      <ion-grid>
        <ion-row>
          <ion-col size="2">
            <img src="assets/icon/m.png" alt="" />
          </ion-col>
          <ion-col size="10">
            <ion-row class="ion-align-items-center">
              <ion-col size="4">
                <span class="menuHeader">Séries</span>
              </ion-col>
              <ion-col size="4">
                <span class="menuHeader">Filmes</span>
              </ion-col>
              <ion-col size="4">
                <span class="menuHeader">Trailers</span>
              </ion-col>
            </ion-row>
          </ion-col>
        </ion-row>
      ...
      <ion-row>
        ...
        <ion-col size="4">
          <ion-button color="light">
            <div>
              <ion-icon class="lblIcon" :icon="playOutline"></ion-icon>
              <ion-label class="lblContrast">Assistir </ion-label>
            </div>
          </ion-button>
        </ion-col>
...
<script>
import { IonHeader, IonPage, IonCol, IonGrid, IonRow } from "@ionic/vue";
import { defineComponent } from "vue";
import { addOutline, alertCircleOutline, playOutline } from "ionicons/icons";
